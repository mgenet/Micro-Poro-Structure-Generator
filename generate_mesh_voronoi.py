...
def voronoi_tessellation(mesh_filename, h, row, domain_y, shift_y, remove_seeds = True):
...
#  domain = 10
    ...
    seeds_filename = "point_seeds_random"
    # seeds_filename = "point_seeds"
    open_file = open(seeds_filename, "rb")
    points = pickle.load(open_file)
    open_file.close()
...
def Hallow_Square(mesh_filename, width, r, shift_x, shift_y):
...
def Porous_media(mesh_filename, width, r, shift_x, shift_y):
...
def Hallow_cube(mesh_filename, width, r, shift_x, shift_y, shift_z):
...
def Hallow_array(mesh_filename, shift_x, shift_y, width):
...
def Hexag_incl(mesh_filename, width, angle, r, shift_x, shift_y):
...
def Hex_rectangle(mesh_filename, width, r, shift_x, shift_y):
